...
window.onload=function setDate() {
    		...
    		var str = "星期" + a[time1.getDay()];
    		var time = time1.getFullYear() + "年" + (time1.getMonth() + 1) + "月" + time1.getDate() + "日" + " 星期" + a[time1.getDay()];
    		document.getElementById("nowdt").innerHTML = time;
		}
function Out(){
